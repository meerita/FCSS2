...
| `md` | `min-width: 768px` | `min-width: 768px` *(same)* |
| `lg` | `min-width: 992px` | `min-width: 992px` *(same)* |
| `xl` | `min-width: 1200px` | `min-width: 1200px` *(same)* |
| `xxl` | `min-width: 1400px` | `min-width: 1400px` *(same)* |
